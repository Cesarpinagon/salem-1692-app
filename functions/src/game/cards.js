...
const DEFINITIONS = [
  ...
  { key: 'ALIBI', name: 'Coartada', description: 'Retira hasta 3 cartas de acusacion de otro jugador.', color: CARD_COLOR.GREEN, trigger: 'ON_PLAY', targetRules: 'OTHER_PLAYER', duration: 'IMMEDIATE', visibility: 'PUBLIC' },
  { key: 'ASYLUM', name: 'Asilo / Proteccion', description: 'Protege permanentemente a otro jugador del ataque de las Brujas durante la Noche.', color: CARD_COLOR.BLUE, trigger: 'ON_PLAY', targetRules: 'OTHER_PLAYER', duration: 'PERMANENT', visibility: 'PUBLIC' },
