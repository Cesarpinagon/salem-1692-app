...
const DEFINITIONS = Object.freeze([
  ...
  { key: 'ASYLUM', name: 'Asilo', description: 'Protege a otro jugador del asesinato de las Brujas durante la Noche.', color: CARD_COLOR.BLUE, trigger: 'ON_PLAY', targetRules: 'OTHER_PLAYER', duration: 'PERMANENT', visibility: 'PUBLIC' },
  { key: 'MERCY', name: 'Piedad', description: 'Impide que se jueguen directamente cartas rojas contra otro jugador.', color: CARD_COLOR.BLUE, trigger: 'ON_PLAY', targetRules: 'OTHER_PLAYER', duration: 'PERMANENT', visibility: 'PUBLIC' },
  { key: 'MATCHMAKER', name: 'Casamentero', description: 'Se juega frente a otro jugador; dos portadores distintos quedan vinculados.', color: CARD_COLOR.BLUE, trigger: 'ON_PLAY', targetRules: 'OTHER_PLAYER', duration: 'PERMANENT', visibility: 'PUBLIC' },
