...
const DEFINITIONS = [
  ...
  { key: 'MATCHMAKER', name: 'Casamiento', description: 'Vincula a dos jugadores: si uno muere, el otro muere inmediatamente.', color: CARD_COLOR.GREEN, trigger: 'ON_PLAY', targetRules: 'TWO_ALIVE_PLAYERS', targetCount: 2, duration: 'PERMANENT', visibility: 'PUBLIC' },
