...
const DEFINITIONS = [
  ...
  { key: 'ASYLUM', name: 'Asilo / Proteccion', description: 'Protege permanentemente a otro jugador contra acusaciones y ataques de la Noche.', color: CARD_COLOR.BLUE, trigger: 'ON_PLAY', targetRules: 'OTHER_PLAYER', duration: 'PERMANENT', visibility: 'PUBLIC' },
