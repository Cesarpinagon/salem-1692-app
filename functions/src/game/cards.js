...
const DEFINITIONS = [
  ...
  { key: 'MATCHMAKER', name: 'Casamiento', description: 'Asigna esta carta a un jugador. Cuando dos jugadores distintos tienen una, quedan casados y comparten un vinculo mortal.', color: CARD_COLOR.GREEN, trigger: 'ON_PLAY', targetRules: 'ANY_ALIVE_PLAYER', targetCount: 1, duration: 'PERMANENT', visibility: 'PUBLIC' },
  { key: 'CONSPIRACY', name: 'Conspiracion', description: 'Cada jugador toma una carta de Juicio oculta del jugador a su izquierda.', color: CARD_COLOR.BLACK, trigger: 'ON_DRAW', targetRules: 'TRYAL_CARD', duration: 'IMMEDIATE', visibility: 'PUBLIC' },
